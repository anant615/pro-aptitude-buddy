...
import { ArrowRight, BookOpen, Brain, MessageSquareText, Clock, Trophy, CalendarDays, FileText, Newspaper, Pencil, Check, X, Sparkles, Zap, Camera, Swords, BarChart3, Target } from "lucide-react";
        ...
        <div className="container">
          <div className="flex items-center justify-between mb-6">
            <h2 className="font-heading text-2xl font-bold flex items-center gap-2">
              ...
              <EditableText storageKey="resources_heading" defaultValue="Free Resources" isAdmin={isAdmin} />
            </h2>
