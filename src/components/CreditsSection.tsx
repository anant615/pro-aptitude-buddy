...
export default function CreditsSection({ context = "mock tests and study material" }: Props) {
  return (
    <motion.div
    ...
    >
      ...
      <p className="text-sm text-muted-foreground leading-relaxed mb-4">
        ...
        whose teaching has been invaluable for students preparing for CAT and other MBA entrance exams.
